...
<section class="<?php echo ( $value ) ? 'checkbox-on' : 'checkbox-off'; ?>">
    ...
    <p class="close-status"><img src="<?php echo get_stylesheet_directory_uri() . '/assets/noun_close.svg' ?>" /></p>
</section>
...
<div class="container">
    <div class="row">
        <div class="col-lg-3">
            <div class="top-logo">
            <a href="<?php echo home_url(); ?>"><img src="<?php echo Kirki::get_option('foatheme_kirki_fields', 'foa_top_logo'); ?>" alt="logo" /></a>
            </div>
        </div>            
        <div class="col-lg-9">
            <?php 
